...
<head>
    ...
    <title>Sento CMS</title>
    
    <link rel="stylesheet" href="<?php echo $assets_uri;?>css/plugins/bootstrap.css" />
    
    <!--    <link rel="stylesheet" href="<?php echo $assets_uri;?>css/general/simple-sidebar.css" /> 
    <link rel="stylesheet" href="<?php echo $assets_uri;?>css/general/navbar.css" /> 
    -->
    ...
    <link rel="stylesheet" href="<?php echo $assets_uri;?>css/general/style4.css">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <center>
                            <label id="label_user_name_session"><?php echo $this->session->userdata('user_name'); ?></label>
                        </center>
                    </h4>
                </div>
