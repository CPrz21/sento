<div ng-controller="HimController">
  <!-- HIM SECTION -->
  <section id="{{himSection.sectionName}}">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <h1>{{himSection.texto_1}}</h1>
          <p>{{himSection.texto_2}}</p>
        </div>
      </div>
    </div>
  </section>
  <!-- HIM OPTIONS SECTION -->
  <section menuscroll id="{{himSection.sectionName}}_optns">
    <div class="container">
      <div class="row">
